...
class Pomme(v0.Pomme):
    ...
    def make_board(self):
        ...
        self._board[self._board == constants.Item.Agent0.value] = constants.Item.Passage.value
        self._board[self._board == constants.Item.Agent2.value] = constants.Item.Passage.value
